...
public final class ActivityWorkerOptions {
    ...
    public static final class Builder {
        ...
        public ActivityWorkerOptions build() {
            ...
            return new ActivityWorkerOptions(identity, dc, taskExecutorThreadPoolSize, po,
    ...
    private ActivityWorkerOptions(String identity, DataConverter dataConverter, int taskExecutorThreadPoolSize,
