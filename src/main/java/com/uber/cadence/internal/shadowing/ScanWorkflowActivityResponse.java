...
public class ScanWorkflowActivityResponse {
  private final List<WorkflowExecution> workflowExecutions;
  private final byte[] pageToken;

  public ScanWorkflowActivityResponse(
      List<WorkflowExecution> workflowExecutions, byte[] pageToken) {
