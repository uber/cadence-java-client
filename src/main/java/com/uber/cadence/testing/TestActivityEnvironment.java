...
public interface TestActivityEnvironment {
   ...
   * @return Promise that contains function result or failure
   */
  <A1, A2, A3, A4, R> R executeActivity(
   ...
   * @return Promise that contains function result or failure
   */
  <A1, A2, A3, A4, A5, R> R executeActivity(
      Functions.Func5<A1, A2, A3, A4, A5, R> function, A1 arg1, A2 arg2, A3 arg3, A4 arg4, A5 arg5);
   ...
   * @return Promise that contains function result or failure
   */
  <A1, A2, A3, A4, A5, A6, R> R executeActivity(
   ...
   * @return Promise that contains activity result or failure
   */
  <A1, A2, A3> Promise<Void> executeActivity(
   ...
   * @return Promise that contains activity result or failure
   */
  <A1, A2, A3, A4> Promise<Void> executeActivity(
   ...
   * @return Promise that contains activity result or failure
   */
  <A1, A2, A3, A4, A5> Promise<Void> executeActivity(
   ...
   * @return Promise that contains activity result or failure
   */
  <A1, A2, A3, A4, A5, A6> Promise<Void> executeActivity(
